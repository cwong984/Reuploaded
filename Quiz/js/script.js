(function() {
  var questions = [{
    ...
    choices: ['Stark', 'Tyrel', "Mortensen" , 'Boltens'],
    correctAnswer: 2
  }, {
    question: " In the first episode of season 1, who accidentally discovers Queen Cersei's secret?",
    choices: ['Arya Stark', 'Bran Stark', 'Joffry Baratheon', 'Tyrion Lanister'],
    correctAnswer: 1
  }, {
    question: "Who is Robb Stark's mother?",
    choices: ['Talisa Stark' , 'Arya Stark' , 'Catelyn Stark' , 'Sansa Stark'],
    correctAnswer: 2
  }, {
    question: "What does Tyrion murder his father with?",
    choices: ['Poison' , 'Sword' , 'Mace' , 'Crossbow'],
    correctAnswer: 3
  }, {
    question: "Who is known as 'The Kingslayer?'",
    choices: ['Sandor Clegane' , 'Joffrey Baratheon' , 'Eddard Stark' , 'Jaime Lannister'],
    correctAnswer: 3
  }];
